...
14. Как узнать существует передаваемый ключ в map или нет?
...
32. Что такое индексы в бд и какие виды индексов знаешь?
...
51. Что такое go mod?
52. Что такое go sum?
53. Как работает defer?
54. Что такое select?
55. Как работает garbage collector?
56. Что такое embedding?
57. Для чего нужен пустой interface?
58. Как объявить private метод?
